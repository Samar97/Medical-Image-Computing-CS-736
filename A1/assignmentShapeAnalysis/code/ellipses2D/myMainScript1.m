...
point_set_data_norm_flat = reshape(point_set_data_norm, [dim*num_points, num_point_sets]);
...
scatter(mean_new(1,:), mean_new(2,:), 50, [1, 0, 0], 'filled', 'd');
scatter(mode_of_var1_inc(1,:), mode_of_var1_inc(2,:), 50, [0, 1, 0], 'filled', 'd');
scatter(mode_of_var1_dec(1,:), mode_of_var1_dec(2,:), 50, [0, 0, 1], 'filled', 'd');
...
scatter(mean_new(1,:), mean_new(2,:), 50, [1, 0, 0], 'filled', 'd');
scatter(mode_of_var2_inc(1,:), mode_of_var2_inc(2,:), 50, [0, 1, 0], 'filled', 'd');
scatter(mode_of_var2_dec(1,:), mode_of_var2_dec(2,:), 50, [0, 0, 1], 'filled', 'd');
